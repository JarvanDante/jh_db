...
CREATE TABLE `site_payment` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='站点绑定支付';

-- ----------------------------
-- Records of site_payment
-- ----------------------------
BEGIN;
INSERT INTO `site_payment` VALUES (1, 1, 1, 'GCash1', 'upay', 1, 'http://54.179.50.129:8961/api/merchant/order', '1098715', 'CPDZMLGK2BON4RP2W3AZ6TRMTAO7MBFX', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:40');
INSERT INTO `site_payment` VALUES (2, 1, 2, 'Maya1', 'Zhongbao', 1, 'http://66.179.50.129:8961/api/merchant/order', '2098715', 'RXYFUP4J64VRPJDUVSKLFR6XEYOB52IL', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:40');
INSERT INTO `site_payment` VALUES (3, 1, 6, 'GCache3', 'tpay', 2, 'http://api.com', '123123123', 'fdskafljdlska', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:40');
INSERT INTO `site_payment` VALUES (4, 1, 5, 'GCash2', 'wzf', 1, 'http://gbtobyk.gt/qymj', '12312312', 'fdsalkfjds', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:40');
COMMIT;
...
CREATE TABLE `site_withdraw` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='站点绑定提现';

-- ----------------------------
-- Records of site_withdraw
-- ----------------------------
BEGIN;
INSERT INTO `site_withdraw` VALUES (1, 1, 7, 'GCash', 'txian', 1, 'http://56123123.com', '123123', 'xkdfjlkdsjlkfsdf', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:41');
INSERT INTO `site_withdraw` VALUES (2, 1, 8, 'Maya', 'fzhifu', 1, 'http://1231233888.com', '123123', 'ffdsfdsjfkladjf', 0.0000, 0.0000, 0, '', 1, '', '', 1, '2026-02-26 22:02:04', '2026-04-28 18:51:41');
COMMIT;
