...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES (1, 'zhuluoji', '超管', '$2a$10$PDxQEQXjVcD8XOdB96yofuEW5rw.xZw.Rj1ztMBaW9lfrkAVYDc6y', 1, 1, 1, 'OF5TNWUM6LCNHHCMYYWLEO5QGMVJMDRE', '1P6V798HHHfZ3Lx1tQZm3ZZxWGJiztKBpEhVmRs71UMPnepzWFVIkiiOP0Qi', '172.19.0.5', '2026-04-01 05:54:16', '2018-07-22 20:44:04', '2026-04-01 05:54:16');
COMMIT;
...
CREATE TABLE `admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='后台员工日志表';

-- ----------------------------
-- Records of admin_log
-- ----------------------------
BEGIN;
INSERT INTO `admin_log` VALUES (1, 1, 'zhuluoji', '172.19.0.5', '2026-03-04 10:20:25', '登录成功');
INSERT INTO `admin_log` VALUES (2, 1, 'zhuluoji', '172.19.0.5', '2026-04-01 05:54:16', '登录成功');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='站点配置发布记录表';

-- ----------------------------
-- Records of site_config_publish_log
-- ----------------------------
BEGIN;
INSERT INTO `site_config_publish_log` VALUES (1, 'jh', 1, 1, 0, 1, 'zhuluoji', '配置发布', '2026-04-01 05:58:48');
INSERT INTO `site_config_publish_log` VALUES (2, 'jh', 2, 1, 1, 1, 'zhuluoji', '配置发布', '2026-04-01 07:12:31');
COMMIT;
...
CREATE TABLE `site_config_snapshot` (
  ...
  UNIQUE KEY `uniq_site_version` (`site_code`,`version`),
  KEY `idx_site_code` (`site_code`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='站点配置快照表（用于回滚）';

-- ----------------------------
-- Records of site_config_snapshot
-- ----------------------------
BEGIN;
INSERT INTO `site_config_snapshot` VALUES (1, 'jh', 1, '{\"Base\": {\"code\": \"jh\", \"status\": 1, \"site_id\": 1, \"currency\": \"MMK(K)\", \"timezone\": \"UTC\", \"db_link_game\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_game?parseTime=true&loc=Local\", \"db_link_site\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_site?parseTime=true&loc=Local\", \"db_link_balance\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_balance?parseTime=true&loc=Local\"}, \"Game\": [{\"name\": \"ONE游戏\", \"type\": 4, \"api_id\": \"a6cd074ecc4ec450090ab0288484e909616d6f17493ecba588bf9c2eb7e35864\", \"api_key\": \"22db26bd9dbb5a707a4df7446010a8fa589d564c602e3dfec190e0c46bbe8523\", \"api_url\": \"https://stg.gasea168.com\", \"db_name\": \"one_api_game\", \"game_id\": 26, \"platform\": \"ONE\", \"image_code\": \"one\"}, {\"name\": \"IG_JILI游戏\", \"type\": 4, \"api_id\": \"FJ999Trans_MMK\", \"api_key\": \"0af14f1b1301355ea98eb9fda7ad61853005aefe\", \"api_url\": \"https://uat-wb-api-2.kijl788du.com/api1\", \"db_name\": \"ig_jili_game\", \"game_id\": 27, \"platform\": \"IG_JILI\", \"image_code\": \"jili\"}], \"Meta\": {\"version\": 1, \"admin_id\": 1, \"published_at\": \"2026-04-01 13:58:48\"}, \"Domain\": {\"h5\": [\"*.jhh5.com\", \"jh.com\"], \"api\": [\"jh1.com\", \"127.0.0.1\"], \"admin\": [\"admin123.com\", \"i.jhbackend.com\"], \"callback\": [\"FDSAF.com\"]}, \"Payment\": [{\"code\": \"upay\", \"logo\": \"http://logo1213.com\", \"name\": \"GCash1\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://54.179.50.129:8961/api/merchant/order\", \"gateway\": 1, \"md5_key\": \"CPDZMLGK2BON4RP2W3AZ6TRMTAO7MBFX\", \"each_max\": 50000, \"each_min\": 100, \"is_input\": 1, \"money_list\": \"100,300,500,1000,2000,5000,10000,30000,50000\", \"payment_id\": 1, \"merchant_no\": \"1098715\"}, {\"code\": \"Zhongbao\", \"logo\": \"\", \"name\": \"Maya1\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://66.179.50.129:8961/api/merchant/order\", \"gateway\": 1, \"md5_key\": \"RXYFUP4J64VRPJDUVSKLFR6XEYOB52IL\", \"each_max\": 50000, \"each_min\": 100, \"is_input\": 1, \"money_list\": \"100,300,500,1000,2000,5000,10000,30000,50000\", \"payment_id\": 2, \"merchant_no\": \"2098715\"}, {\"code\": \"tpay\", \"logo\": \"http://123123123.com\", \"name\": \"GCache3\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://api.com\", \"gateway\": 2, \"md5_key\": \"fdskafljdlska\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 0, \"money_list\": \"1,2,3,4,5,6\", \"payment_id\": 6, \"merchant_no\": \"123123123\"}, {\"code\": \"wzf\", \"logo\": \"Excepteur nostrud ipsum magna sint\", \"name\": \"GCash2\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://gbtobyk.gt/qymj\", \"gateway\": 1, \"md5_key\": \"fdsalkfjds\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"50,100,500,600\", \"payment_id\": 5, \"merchant_no\": \"12312312\"}], \"Activity\": [{\"uri\": \"/invite_activity\", \"code\": \"INVITE\", \"name\": \"Invite Friends\", \"sort\": 0, \"table\": \"activity_invite_bonus\", \"status\": 1, \"end_time\": \"2026-11-25 16:00:00\", \"start_time\": \"2025-12-26 16:00:00\", \"activity_id\": 1, \"fixed_params\": \"{\\\"reward_type\\\": 1, \\\"trigger_event\\\": 1, \\\"min_recharge_amount\\\": 80, \\\"inviter_reward_amount\\\": 10}\", \"activity_type\": \"10\"}, {\"uri\": \"/register_activity\", \"code\": \"REGISTER\", \"name\": \"REGISTER BONUS\", \"sort\": 0, \"table\": \"activity_register_bonus\", \"status\": 1, \"end_time\": \"2027-01-29 08:00:00\", \"start_time\": \"2026-01-29 08:00:00\", \"activity_id\": 3, \"fixed_params\": \"{\\\"limit_ip\\\": 1, \\\"limit_device\\\": 1, \\\"reward_amount\\\": 20}\", \"activity_type\": \"5\"}, {\"uri\": \"/deposit_activity\", \"code\": \"DEPOSIT\", \"name\": \"DEPOSIT BONUS\", \"sort\": 0, \"table\": \"activity_deposit_bonus\", \"status\": 1, \"end_time\": \"2027-01-27 16:00:00\", \"start_time\": \"2026-01-27 16:00:00\", \"activity_id\": 4, \"fixed_params\": \"{\\\"reward_type\\\": 1, \\\"reward_amount\\\": 70, \\\"trigger_event\\\": 1, \\\"min_recharge_amount\\\": 550}\", \"activity_type\": \"6\"}, {\"uri\": \"/signin_activity\", \"code\": \"SIGNIN\", \"name\": \"DAILY CHECK-IN\", \"sort\": 0, \"table\": \"activity_signin_bonus\", \"status\": 1, \"end_time\": \"2027-01-28 08:00:00\", \"start_time\": \"2026-01-28 08:00:00\", \"activity_id\": 6, \"fixed_params\": \"{}\", \"activity_type\": \"8\"}, {\"uri\": \"/lucky_activity\", \"code\": \"LUCKY\", \"name\": \"LUCKY SPIN\", \"sort\": 0, \"table\": \"activity_wheel_bonus\", \"status\": 1, \"end_time\": \"2027-01-28 08:00:00\", \"start_time\": \"2026-01-28 08:00:00\", \"activity_id\": 7, \"fixed_params\": \"{}\", \"activity_type\": \"9\"}], \"Withdraw\": [{\"code\": \"txian\", \"logo\": \"http://logo.com\", \"name\": \"GCash\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://56123123.com\", \"gateway\": 1, \"md5_key\": \"xkdfjlkdsjlkfsdf\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"100,200,300,5000\", \"merchant_no\": \"123123\", \"withdraw_id\": 7}, {\"code\": \"fzhifu\", \"logo\": \"http://12333logo.com\", \"name\": \"Maya\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://1231233888.com\", \"gateway\": 1, \"md5_key\": \"ffdsfdsjfkladjf\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"100,200,300,5000\", \"merchant_no\": \"123123\", \"withdraw_id\": 8}]}', '2026-04-01 05:58:48');
INSERT INTO `site_config_snapshot` VALUES (2, 'jh', 2, '{\"Base\": {\"code\": \"jh\", \"status\": 1, \"site_id\": 1, \"currency\": \"MMK(K)\", \"timezone\": \"UTC\", \"db_link_game\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_game?parseTime=true&loc=Local\", \"db_link_site\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_site?parseTime=true&loc=Local\", \"db_link_balance\": \"mysql:root:654321@tcp(172.19.0.4:3306)/jh_balance?parseTime=true&loc=Local\"}, \"Game\": [{\"name\": \"ONE游戏\", \"type\": 4, \"api_id\": \"a6cd074ecc4ec450090ab0288484e909616d6f17493ecba588bf9c2eb7e35864\", \"api_key\": \"22db26bd9dbb5a707a4df7446010a8fa589d564c602e3dfec190e0c46bbe8523\", \"api_url\": \"https://stg.gasea168.com\", \"db_name\": \"one_api_game\", \"game_id\": 26, \"platform\": \"ONE\", \"image_code\": \"one\"}, {\"name\": \"IG_JILI游戏\", \"type\": 4, \"api_id\": \"FJ999Trans_MMK\", \"api_key\": \"0af14f1b1301355ea98eb9fda7ad61853005aefe\", \"api_url\": \"https://uat-wb-api-2.kijl788du.com/api1\", \"db_name\": \"ig_jili_game\", \"game_id\": 27, \"platform\": \"IG_JILI\", \"image_code\": \"jili\"}], \"Meta\": {\"version\": 2, \"admin_id\": 1, \"published_at\": \"2026-04-01 15:12:30\"}, \"Domain\": {\"h5\": [\"*.jhh5.com\", \"jh.com\"], \"api\": [\"jh1.com\", \"127.0.0.1\"], \"admin\": [\"admin123.com\", \"i.jhbackend.com\"], \"callback\": [\"FDSAF.com\"]}, \"Payment\": [{\"code\": \"upay\", \"logo\": \"http://logo1213.com\", \"name\": \"GCash1\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://54.179.50.129:8961/api/merchant/order\", \"gateway\": 1, \"md5_key\": \"CPDZMLGK2BON4RP2W3AZ6TRMTAO7MBFX\", \"each_max\": 50000, \"each_min\": 100, \"is_input\": 1, \"money_list\": \"100,300,500,1000,2000,5000,10000,30000,50000\", \"payment_id\": 1, \"merchant_no\": \"1098715\"}, {\"code\": \"Zhongbao\", \"logo\": \"\", \"name\": \"Maya1\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://66.179.50.129:8961/api/merchant/order\", \"gateway\": 1, \"md5_key\": \"RXYFUP4J64VRPJDUVSKLFR6XEYOB52IL\", \"each_max\": 50000, \"each_min\": 100, \"is_input\": 1, \"money_list\": \"100,300,500,1000,2000,5000,10000,30000,50000\", \"payment_id\": 2, \"merchant_no\": \"2098715\"}, {\"code\": \"tpay\", \"logo\": \"http://123123123.com\", \"name\": \"GCache3\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://api.com\", \"gateway\": 2, \"md5_key\": \"fdskafljdlska\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 0, \"money_list\": \"1,2,3,4,5,6\", \"payment_id\": 6, \"merchant_no\": \"123123123\"}, {\"code\": \"wzf\", \"logo\": \"Excepteur nostrud ipsum magna sint\", \"name\": \"GCash2\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://gbtobyk.gt/qymj\", \"gateway\": 1, \"md5_key\": \"fdsalkfjds\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"50,100,500,600\", \"payment_id\": 5, \"merchant_no\": \"12312312\"}], \"Activity\": [{\"uri\": \"/invite_activity\", \"code\": \"INVITE\", \"name\": \"Invite Friends\", \"sort\": 0, \"table\": \"activity_invite_bonus\", \"status\": 1, \"end_time\": \"2026-11-25 16:00:00\", \"start_time\": \"2025-12-26 16:00:00\", \"activity_id\": 1, \"fixed_params\": \"{\\\"reward_type\\\": 1, \\\"trigger_event\\\": 1, \\\"min_recharge_amount\\\": 80, \\\"inviter_reward_amount\\\": 10}\", \"activity_type\": \"10\"}, {\"uri\": \"/register_activity\", \"code\": \"REGISTER\", \"name\": \"REGISTER BONUS\", \"sort\": 0, \"table\": \"activity_register_bonus\", \"status\": 1, \"end_time\": \"2027-01-29 08:00:00\", \"start_time\": \"2026-01-29 08:00:00\", \"activity_id\": 3, \"fixed_params\": \"{\\\"limit_ip\\\": 1, \\\"limit_device\\\": 1, \\\"reward_amount\\\": 20}\", \"activity_type\": \"5\"}, {\"uri\": \"/deposit_activity\", \"code\": \"DEPOSIT\", \"name\": \"DEPOSIT BONUS\", \"sort\": 0, \"table\": \"activity_deposit_bonus\", \"status\": 1, \"end_time\": \"2027-01-27 16:00:00\", \"start_time\": \"2026-01-27 16:00:00\", \"activity_id\": 4, \"fixed_params\": \"{\\\"reward_type\\\": 1, \\\"reward_amount\\\": 70, \\\"trigger_event\\\": 1, \\\"min_recharge_amount\\\": 550}\", \"activity_type\": \"6\"}, {\"uri\": \"/signin_activity\", \"code\": \"SIGNIN\", \"name\": \"DAILY CHECK-IN\", \"sort\": 0, \"table\": \"activity_signin_bonus\", \"status\": 1, \"end_time\": \"2027-01-28 08:00:00\", \"start_time\": \"2026-01-28 08:00:00\", \"activity_id\": 6, \"fixed_params\": \"{}\", \"activity_type\": \"8\"}, {\"uri\": \"/lucky_activity\", \"code\": \"LUCKY\", \"name\": \"LUCKY SPIN\", \"sort\": 0, \"table\": \"activity_wheel_bonus\", \"status\": 1, \"end_time\": \"2027-01-28 08:00:00\", \"start_time\": \"2026-01-28 08:00:00\", \"activity_id\": 7, \"fixed_params\": \"{}\", \"activity_type\": \"9\"}], \"Withdraw\": [{\"code\": \"txian\", \"logo\": \"http://logo.com\", \"name\": \"GCash\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://56123123.com\", \"gateway\": 1, \"md5_key\": \"xkdfjlkdsjlkfsdf\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"100,200,300,5000\", \"merchant_no\": \"123123\", \"withdraw_id\": 7}, {\"code\": \"fzhifu\", \"logo\": \"http://12333logo.com\", \"name\": \"Maya\", \"sort\": 0, \"status\": 1, \"api_url\": \"http://1231233888.com\", \"gateway\": 1, \"md5_key\": \"ffdsfdsjfkladjf\", \"each_max\": 50000, \"each_min\": 10, \"is_input\": 1, \"money_list\": \"100,200,300,5000\", \"merchant_no\": \"123123\", \"withdraw_id\": 8}]}', '2026-04-01 07:12:31');
COMMIT;
...
-- ----------------------------
-- Records of site_config_version
-- ----------------------------
BEGIN;
INSERT INTO `site_config_version` VALUES ('jh', 2, '2026-04-01 07:12:31');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='域名与站点绑定';
...
INSERT INTO `site_domain` VALUES (9, 'jh', '127.0.0.1', '1', 1, '2026-04-01 05:58:34', '2026-04-01 05:58:34');
COMMIT;
