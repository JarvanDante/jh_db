...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='充值送活动参数配置';

-- ----------------------------
-- Records of activity_deposit_bonus
-- ----------------------------
BEGIN;
INSERT INTO `activity_deposit_bonus` VALUES (1, 'jh', 4, 1, 1, 550.00, 70.00, '2026-02-26 22:02:04', '2026-02-26 22:02:04');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='邀请朋友活动参数配置';

-- ----------------------------
-- Records of activity_invite_bonus
-- ----------------------------
BEGIN;
INSERT INTO `activity_invite_bonus` VALUES (1, 'jh', 1, 1, 1, 80.00, 10.00, '2026-02-26 22:02:04', '2026-02-26 22:02:04');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='注册送活动参数配置';

-- ----------------------------
-- Records of activity_register_bonus
-- ----------------------------
BEGIN;
INSERT INTO `activity_register_bonus` VALUES (1, 'jh', 3, 20.00, 1, 1, '2026-02-26 22:02:04', '2026-02-26 22:02:04');
COMMIT;
...
CREATE TABLE `ad` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='广告';

-- ----------------------------
-- Records of ad
-- ----------------------------
BEGIN;
INSERT INTO `ad` VALUES (1, 1, 1, 'ad1', 'http://localhost:19000/uploads/jh/2026/04/jh_2026_02_banner_extra_15_1772126977_1775025282.webp', 'lucky_activity', '2026-03-01 00:00:00', '2027-04-01 00:00:00', 2, 1, 1, 1, '2026-04-01 14:35:15', '2026-04-01 14:36:52');
INSERT INTO `ad` VALUES (2, 1, 1, 'ad2', 'http://localhost:19000/uploads/jh/2026/04/deposit_bonus_750x360_noblur_1775025380.webp', '/deposit_activity', '2026-03-01 00:00:00', '2027-04-01 00:00:00', 1, 1, 1, 1, '2026-04-01 14:36:32', '2026-04-01 14:36:56');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES (1, 1, 'admin', '超管', '$2a$10$Vb7kNiv0h3cZuDiRU5CwiuKHlrUN3KQA8lPKbC/lqXJkFqi62Wqp2', 1, 1, 1, 'SJX5ALIGCHJAHVGUIMBEANKJ62WKRZEK', 1, '6', 1, '127.0.0.1', '2026-04-01 14:07:29', '2017-11-04 17:22:28', '2026-04-01 14:07:29', NULL);
COMMIT;
...
CREATE TABLE `admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='后台员工日志表';

-- ----------------------------
-- Records of admin_log
-- ----------------------------
BEGIN;
INSERT INTO `admin_log` VALUES (1, 1, 1, 'admin', '127.0.0.1', '2026-03-04 18:11:12', '登录成功');
INSERT INTO `admin_log` VALUES (2, 1, 1, 'admin', '127.0.0.1', '2026-04-01 14:05:35', '登录成功');
INSERT INTO `admin_log` VALUES (3, 1, 1, 'admin', '127.0.0.1', '2026-04-01 14:06:48', '登录成功');
INSERT INTO `admin_log` VALUES (4, 1, 1, 'admin', '127.0.0.1', '2026-04-01 14:07:29', '登录成功');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='MQ Outbox 表（可靠消息）';

-- ----------------------------
-- Records of mq_outbox
-- ----------------------------
BEGIN;
INSERT INTO `mq_outbox` VALUES (1, 'user_created', 'user', '1', 'jh', 'user.created', 'user.init_balance', '{\"site_id\": 1, \"user_id\": 1, \"currency\": \"MMK(K)\", \"username\": \"javany1\"}', 1, 0, '2026-04-01 14:37:29', NULL, '2026-04-01 14:37:30', '2026-04-01 14:37:30');
INSERT INTO `mq_outbox` VALUES (2, 'user_created', 'user', '1', 'jh', 'user.created', 'user.sync_to_game', '{\"site_id\": 1, \"user_id\": 1, \"agent_id\": 0, \"username\": \"javany1\", \"site_code\": \"jh\"}', 1, 0, '2026-04-01 14:37:30', NULL, '2026-04-01 14:37:30', '2026-04-01 14:37:30');
INSERT INTO `mq_outbox` VALUES (3, 'user_sync_clickhouse', 'user', '1', 'jh', 'analytics.sync', 'analytics.user', '{\"status\": 1, \"site_id\": 1, \"user_id\": 1, \"event_id\": 3, \"username\": \"javany1\", \"pay_times\": 0, \"created_at\": \"2026-04-01 14:37:29\", \"inviter_id\": 0, \"updated_at\": \"2026-04-01 14:37:29\", \"register_ip\": \"172.19.0.5\", \"register_time\": \"2026-04-01 14:37:29\"}', 0, 0, '2026-04-01 14:37:30', NULL, '2026-04-01 14:37:30', '2026-04-01 14:37:30');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (1, 1, 1, 0, 0, 'javany1', '$2a$10$qRvs3ddb9FSPSkhcX19KEu554GwDbY7m2Ajfi4AmvHnb51XcCdK/S', '', 1, '172.19.0.5', '2026-04-01 14:37:29', '127.0.0.1', '172.19.0.5', '2026-04-01 14:37:30', '', '', '', NULL, 0, '', '2026-04-01 14:37:29', '2026-04-01 14:37:30', 0, 1);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户消息实例';

-- ----------------------------
-- Records of user_message
-- ----------------------------
BEGIN;
INSERT INTO `user_message` VALUES (1, 1, 1, 1, 'REGISTER_SYSTEM', 'REGISTER_1', NULL, NULL, '🎉 Registration Successful', 'Welcome aboard 🎊 Great promotions are waiting for you!', 1, '2026-04-01 15:48:46', NULL, '2026-04-01 14:37:30', '2026-04-01 15:48:46');
COMMIT;
